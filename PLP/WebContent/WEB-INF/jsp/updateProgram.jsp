...
</nav>		<form:form action="update.htm"
				method="post" modelAttribute="programsScheduled">

<table align="center" class="table table-condensed" style="width: 50%;">
	<caption style="background-color: black;text-align:center;"><font color="white"><b>Update program</b></font></caption>
<tr><td>Program Id</td><td><form:input path="scheduledProgrammeId"
			...
			<tr><td colspan="2"><input class="btn btn-default" type="submit" value="Update"/></td></tr>
					</table>
			</form:form>
